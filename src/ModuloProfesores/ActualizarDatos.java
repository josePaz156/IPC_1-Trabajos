...
public class ActualizarDatos extends javax.swing.JFrame {
    ...
    public void meterDatos() {
        CodigoInput.setText(Inicio.codigo);
        NombreInput.setText(Inicio.nombre);
        ApellidoInput.setText(Inicio.apellido);
        CorreoInput.setText(Inicio.correo);
        PasswordInput.setText(Inicio.contrasenia);
        GeneroInput.setText(Inicio.genero);
    }

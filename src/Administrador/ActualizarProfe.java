...
public class ActualizarProfe extends javax.swing.JFrame {
    ...
    private void ActualizarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActualizarBtnActionPerformed
        ...
        int fila = AdminProfesores.fila;

        AdminProfesores.profesores[fila] = nuevoProfesor;
    ...
    public void meterDatos() {
        CodigoInput.setText(AdminProfesores.codigo);
        NombreInput.setText(AdminProfesores.nombre);
        ApellidoInput.setText(AdminProfesores.apellido);
        CorreoInput.setText(AdminProfesores.correo);
        PasswordInput.setText(AdminProfesores.contrasenia);
        GeneroInput.setText(AdminProfesores.genero);
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarProfe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizarProfe().setVisible(true);
            }
        });
    }
